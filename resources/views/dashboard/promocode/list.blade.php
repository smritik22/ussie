    ...
    <div class="padding website-label">
        <div class="box">
            <div class="box-header dker">
                <h3>{{ __('backend.promocode_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.promocode_management') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('promocode.create')}}">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; {{ __('backend.newpromocode') }}
                                </a>
                            </li>
                </ul>
            </div>

            {{ Form::open(['route' => 'promocode.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('promocode.anyData') !!} ";
        ...
        $(document).on('submit', '#updateAll', function(e) {
            ...
            if (type == 'no') {
                ...
                if (allVals.length <= 0) {
                    ...
                    if (type == 2) {
                        msg = "Are you sure you want to inactive this promocode?";

                    } else if (type == 1) {
                        msg = "Are you sure you want to active this promocode?";
                    }else if (type == 3) {
                        msg = "Are you sure you want to delete this promocode?";
                    }
                     else {
                        msg = "Are you sure you want to delete this promocode?";
                    }
