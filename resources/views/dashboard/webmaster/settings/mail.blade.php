<div class="tab-pane {{  ( Session::get('active_tab') == 'mailSettingsTab') ? 'active' : '' }}"
    ...
    <div class="p-a-md col-md-12 b-b m-b-2">
        <div class="row">
            ...
            {{--  <div class="col-sm-5 form-group" id="facebook_link">
                <label>Facebook Link</label>
                {!! Form::text('facebook_link',env("FACEBOOK_LINK"), array('id' => 'facebook_link','class' => 'form-control', 'dir'=>'ltr')) !!}
            </div>
            <div class="col-sm-7 form-group" id="instagram_link">
                <label>Instagram Link</label>
                {!! Form::text('instagram_link',env("INSTAGRAM_LINK"), array('id' => 'instagram_link','class' => 'form-control', 'dir'=>'ltr')) !!}
            </div>

            <div class="col-sm-5 form-group" id="twitter_link">
                <label>Twitter Link</label>
                {!! Form::text('twitter_link',env("TWITTER_LINK"), array('id' => 'twitter_link','class' => 'form-control', 'dir'=>'ltr')) !!}
            </div>  --}}
            {{--<div class="col-sm-7 form-group" id="linkdin_link">
