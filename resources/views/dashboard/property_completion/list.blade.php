...
@section('title', __('backend.completion'))
@section('content')
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.completion') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.completion') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('completion.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.add_completion') }}
                        </a>
                    </li>
            ...
            {{ Form::open(['route' => 'completion.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="completion">
                    <thead class="dker">
                        <tr>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('completion.anyData') !!} ";
                $('#completion').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    ordering: true,
                    ...
                    columns: [{
                        ...
                        {
                            data: 'property_completion',
                            name: 'property_completion',
