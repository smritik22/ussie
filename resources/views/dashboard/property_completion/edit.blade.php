...
@section('title', __('backend.edit_completion'))
@push("after-styles")
...
@section('content')
    <div class="padding edit-package">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['completion.update',$completion->id],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'completionForm' ])}}

                <div class="personal_informations">
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label">{!!  __('backend.completion') !!}</label>
                        <div class="col-sm-9">
                            <input type="text" name="completion" id="completion" class="form-control" placeholder="{{__('backend.completion')}}" value="{{$completion->completion_type}}">
