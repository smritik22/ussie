...
@section('title', __('backend.editGeneralUser'))
@push("after-styles")
        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.editGeneralUser') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('generalusers') }}">{{ __('backend.general_user_mngmnt') }}</a> / 
                    <span>{{ __('backend.editGeneralUser') }}</span>

                </small>
            </div>
            <div class="box-body">
                {{Form::open(['route'=>['generaluser.update',$user->id],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'userForm' ])}}
                {{ csrf_field() }}
