        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                   ...
                   <a href="{{ route('passenger-report') }}">{{ __('backend.passenger_report') }}</a> /
                   <span>{{ __('backend.view_passenger_report') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('passenger-report')}}">
                                    &nbsp; {{ __('backend.backs') }}
                                </a>
                            </li>
                </ul>
            ...
            <div class="box-body">
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2">
                        <a href="{{ route('passenger-report') }}" class="btn btn-default m-t show_button" style="margin: 0 0 0 0px">
