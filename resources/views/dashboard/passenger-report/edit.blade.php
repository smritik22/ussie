        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    ...
                    <a href="{{ route('generalusers') }}">{{ __('backend.passenger_management') }}</a> / 
                    <span>{{ __('backend.editPassengerUser') }}</span>

                </small>
            </div>
            <div class="box-body">
                {{Form::open(['route'=>['passenger.update',$user->id],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'userForm' ])}}
                {{ csrf_field() }}
