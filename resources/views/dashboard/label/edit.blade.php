            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="label_key" id="label_key" class="form-control" placeholder="Label Key" onfocus="validateMsgHide('label_key')" value="{{$label->Label_key}}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="label_value" id="label_value" class="form-control" placeholder="Label Value" onfocus="validateMsgHide('label_value')" value="{{old('Label_value',$label->Label_value)}}">
                        </div>
