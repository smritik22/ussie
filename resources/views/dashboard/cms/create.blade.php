            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        <cms class="col-sm-2 form-control-cms">Page Name <span class="valid_field">*</span></cms>
                        <div class="col-sm-10">
                            <input type="text" name="page_name" id="page_name" class="form-control" placeholder="Name" onfocus="validateMsgHide('page_name')" value="{{old('page_name')}}">
                    ...
                    <div class="form-group row">
                        <cms class="col-sm-2 form-control-cms">Page Content <span class="valid_field">*</span></cms>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="page_content" name="page_content" value="{{old('page_content')}}" onfocus="validateMsgHide('page_content')" autofocus ></textarea>
