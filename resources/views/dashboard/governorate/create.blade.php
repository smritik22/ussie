...
@section('title', __('backend.topicNew') . " " . __('backend.governorate'))
@push("after-styles")
        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.topicNew') }} {{ __('backend.governorate') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('governorate') }}">{{ __('backend.governorates') }}</a> / 
                    <span>{{ __('backend.topicNew') }} {{ __('backend.governorate') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['governorate.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'governorateForm' ])}}
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="governorate_name" id="governorate_name" class="form-control" placeholder="Governorate Name" value="{{old('governorate_name')}}" maxlength="100">
                            <span class="help-block">
