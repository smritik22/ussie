...
@section('title', __('backend.condition'))
@section('content')
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.condition') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.condition') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('condition.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.add_condition') }}
                        </a>
                    </li>
            ...
            {{ Form::open(['route' => 'condition.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="condition">
                    <thead class="dker">
                        <tr>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('condition.anyData') !!} ";
                $('#condition').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
