...
?>
@section('title', __('backend.topicNew') . " " . __('backend.country'))
@push("after-styles")
        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.topicNew') }} {{ __('backend.country') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('country') }}">{{ __('backend.countries') }}</a> / 
                    <span>{{ __('backend.topicNew') }} {{ __('backend.country') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['country.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'countryForm' ])}}

                <div class="personal_informations">
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label">{!!  __('backend.country_name') !!}</label>
                        <div class="col-sm-10">
                            <input type="text" name="country_name" id="country_name" class="form-control" placeholder="Country Name" value="{{old('country_name')}}" maxlength="100">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="country_code" id="country_code" class="form-control" placeholder="Country Code" maxlength="4" value="{{old('country_code')}}">
                            <span class="help-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="currency_code" id="currency_code" class="form-control" placeholder="{!!  __('backend.currency_code') !!}" value="{{old('currency_code')}}" maxlength="4">
                            <span class="help-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="currency_decimal_point" id="currency_decimal_point" class="form-control" placeholder="{!!  __('backend.currency_decimal_point') !!}" value="{{old('currency_decimal_point')}}" maxlength="1">
                            <span class="help-block">
