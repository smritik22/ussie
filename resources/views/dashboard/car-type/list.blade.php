    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.car_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.car_type') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('car-type.create')}}">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; {{ __('backend.newcartype') }}
                                </a>
                            </li>
                </ul>
            </div>

            {{ Form::open(['route' => 'car-type.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
                    ...
                    <thead class="dker">
                        <tr>
                            ...
                            <th>{{ __('backend.car_type') }}</th>
                             <th style="width: 310px !important;">{{ __('backend.description') }}</th>

                            <th>{{ __('backend.car_type_image') }}</th>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('car-type.anyData') !!} ";
        ...
        $(document).on('submit', '#updateAll', function(e) {
            ...
            if (type == 'no') {
                ...
                if (allVals.length <= 0) {
                    ...
                    if (type == 0) {
                        msg = "Are you sure you want to inactive this car-type?";

                    } else if (type == 1) {
                        msg = "Are you sure you want to active this car-type?";
                    }else if (type == 3) {
                        msg = "Are you sure you want to delete this car-type?";
                    }
                     else {
                        msg = "Are you sure you want to delete this car-type?";
                    }
