    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.passenger_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.passenger_management') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('passenger.create')}}">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; {{ __('backend.newPassengerAdd') }}
                                </a>
                            </li>
                </ul>
            </div>

            {{ Form::open(['route' => 'passenger.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('passenger.anyData') !!} ";
