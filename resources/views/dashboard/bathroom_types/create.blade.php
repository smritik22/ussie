...
@section('title', __('backend.add_bathroom_type'))
@push('after-styles')
        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.add_bathroom_type') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="{{ route('bathroom_type') }}">{{ __('backend.bathroom_types') }}</a> /
                    <span>{{ __('backend.add_bathroom_type') }}</span>
                </small>
            </div>

            <div class="box-body">
                {{ Form::open(['route' => ['bathroom_type.store'],'method' => 'POST','files' => true,'enctype' => 'multipart/form-data','id' => 'bathroom_typeForm']) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="type" id="type" class="form-control"
                                placeholder="{{ __('backend.bathroom_type') }}" value="{{ old('type') }}"
                                maxlength="100">
