...
@section('title', __('backend.bathroom_type'))
@section('content')
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.bathroom_types') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.bathroom_types') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('bathroom_type.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.add_bathroom_type') }}
                        </a>
                    </li>
            ...
            {{ Form::open(['route' => 'bathroom_type.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="bathroom_type">
                    <thead class="dker">
                        <tr>
                            ...
                            <th>{{ __('backend.bathroom_type') }}</th>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('bathroom_type.anyData') !!} ";
                $('#bathroom_type').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    ordering: true,
