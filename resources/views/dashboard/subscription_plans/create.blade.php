            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="no_of_plan_post" id="no_of_plan_post" class="form-control" onkeydown="return restrictInput(this,event,'digits')"
                                placeholder="{{ __('backend.number_of_ads') }}" value="{{ old('no_of_plan_post') }}"
                                maxlength="5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::checkbox('is_featured', 1, old('is_featured')?true:false, ['class' => 'from-control-label','style'=> 'margin-top:15px;','id'=> 'is_featured']) !!}
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <select name="plan_type" id="plan_type" class="form-control">
                                ...
                                @foreach (config('constants.AGENT_TYPE') as $item)
                                    <option @if(old('plan_type') == $item['value']) @selected(true) @endif value="{{$item['value']}}" >{{ Helper::getLabelValueByKey($item['label_key']) }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="no_of_default_featured_post" id="no_of_default_featured_post" class="form-control" onkeydown="return restrictInput(this,event,'digits')"
                                placeholder="{{ __('backend.no_of_default_featured_post') }}" value="{{ old('no_of_default_featured_post') }}"
                                maxlength="5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="extra_each_normal_post_price" id="extra_each_normal_post_price" class="form-control decimal"
                                placeholder="{{ __('backend.extra_each_normal_post_price') }}" value="{{ old('extra_each_normal_post_price') }}"
                                maxlength="15">
