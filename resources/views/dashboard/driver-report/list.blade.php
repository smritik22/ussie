    ...
    <div class="padding school-report-manage list-school">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.driver_report') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.driver_report') }}</span>
                </small>
            </div>
            
            {{ Form::open(['route' => 'report.driver.export', 'method' => 'post', 'id' => 'export']) }}
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function load_data(startdate, enddate) {
                ...
                var action_url = "{!! route('driver-report.anyData') !!} ";
