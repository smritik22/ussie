...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['certificate.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'emailtemplateForm' ])}}
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        <emailtemplate class="col-sm-2 form-control-emailtemplate">Subject </emailtemplate>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="page_content" name="content" autofocus ></textarea>
                        </div>
                    </div>
