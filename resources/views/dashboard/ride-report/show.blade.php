        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                   ...
                   <a href="{{ route('ride-report') }}">{{ __('backend.ride_management') }}</a> /
            ...
            <div class="box-tool">
                <ul class="nav">
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('ride-report')}}">
                                    &nbsp; {{ __('backend.backs') }}
                                </a>
                            </li>
                </ul>
                ...
                {{Form::open(['route'=>['generalusers'],'method'=>'GET', 'files' => true,'enctype' => 'multipart/form-data' ])}}
                 ...
                 <div class="personal_informations">
                            <table class="table table-bordered m-a-0">
                                ...
                                <?php
                    $start_date = \Helper::converttimeTozone($ride_data[0]->start_date);
                    ?>
                                <tr>
                                    <tbody>
