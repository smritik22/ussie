...
@section('title', __('backend.driver_reject_list'))
@section('content')
<style type="text/css">
    .Pending{
        color: #F92E3D;
    ...
    <div class="padding school-report-manage list-school">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.driver_reject_list') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.driver_reject_list') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            {{ Form::close() }} -->
            <input type="hidden" name="ride_id" value="{{ isset($ride_id) ? $ride_id : '' }}"
                    id="ride_id">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function load_data() {
                ...
                var action_url = "{!! route('ride.riderejectanyData') !!} ";
                    ...
                    ajax: {
                        ...
                        data: function(d) {
                            return $.extend({}, d, {
                                ...
                                "ride_id": $("#ride_id").val().toLowerCase(),
