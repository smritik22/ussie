...
@section('title', __('backend.property_type'))
@section('content')
    ...
    <div class="padding website-label">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.property_type') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.property_type') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="{{ route('property_type.create') }}">
                            <i class="material-icons">&#xe7fe;</i>
                            &nbsp; {{ __('backend.add_property_type') }}
                        </a>
                    </li>
            ...
            {{ Form::open(['route' => 'property_type.updateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered m-a-0" id="property_type">
                    <thead class="dker">
                        <tr>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('property_type.anyData') !!} ";
                $('#property_type').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    ordering: true,
