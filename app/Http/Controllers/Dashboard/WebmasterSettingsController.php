...
class WebmasterSettingsController extends Controller
{
    ...
    public function edit()
    {
        ...
        if (!empty($WebmasterSetting)) {
            return view("dashboard.webmaster.settings.home", compact("WebmasterSetting","Languages", "setting"));
        } else {
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($WebmasterSetting)) {
            ...
            $WebmasterSetting->copyright_ar = $request->copyright_ar;

            $WebmasterSetting->site_title_en = $request->site_title_en;
            $WebmasterSetting->site_title_ar = $request->site_title_ar;
            ...
            // $WebmasterSetting->gap_of_package = isset($request->gap_of_package) ? $request->gap_of_package : 0;
            ...
            $settings->facebook_link = isset($request->facebook_link) ? $request->facebook_link : '';
            $settings->instagram_link =  isset($request->instagram_link) ? $request->instagram_link : '';
            $settings->phone = isset($request->phone) ? $request->phone :"";
            $settings->address = isset($request->address) ? $request->address :"";
            $settings->youtube_link =  isset($request->youtube_link) ? $request->youtube_link : '';
            $settings->twitter_link =  isset($request->twitter_link) ? $request->twitter_link : '';
            $settings->linkdin_link =  isset($request->linkdin_link) ? $request->linkdin_link : '';
            $settings->currency =  isset($request->currency) ? $request->currency : '';
            $settings->admin_commision =  isset($request->admin_commision) ? $request->admin_commision : '';
            $settings->android_version =  isset($request->android_version) ? $request->android_version : '';
            $settings->cancle_fees =  isset($request->cancle_fees) ? $request->cancle_fees : '';
            $settings->ios_version =  isset($request->ios_version) ? $request->ios_version : '';
            $settings->save();
            ...
            $env_update = $this->changeEnv([
                ...
                'LINKDIN_LINK' => isset($request->linkdin_link) ? $request->linkdin_link : '',
            ]);
